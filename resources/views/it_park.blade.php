...
.tabcontent {
  ...
  border-top: none;
        ...
        <div class="g-bg-position--center js__parallax-window" style="background: url(frontend_theme/frontend_images/image6.png) 50% 0 no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-padding-y-150--xs">
                ...
                <h1 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white g-letter-spacing--1">IT PARK</h1>
            </div>
        </div>
        <!--========== END PROMO BLOCK ==========-->
        ...
        <div class="g-bg-color--sky-light">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-80--xs">
                    ...
                    <h2 class="g-font-size-32--xs g-font-size-36--md g-letter-spacing--1">Our Client</h2>
                </div>
                <div class="bs-example">
                    <ul class="nav nav-pills">
                        <div class="tab">
                            <button class="tablinks active" onclick="openCity(event, 'London')">Mahindra Business Solution</button>
                            <button class="tablinks" onclick="openCity(event, 'Paris')">iPing Data Labs</button>
                ...
                <div id="London" class="tabcontent" style="display:block">
                  <div class="row">
                    <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="frontend_theme/frontend_images/mahindra/img2.png" alt="Image">
<!--                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                    ...
                    <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="frontend_theme/frontend_images/mahindra/img3.png" alt="Image">
<!--                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                     ...
                     <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="frontend_theme/frontend_images/mahindra/img1.png" alt="Image">
<!--                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                ...
                <div id="Paris" class="tabcontent">
                  <div class="row">
                    <div class="col-sm-3 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="frontend_theme/frontend_images/iping/1.png" alt="Image">
<!--                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                    ...
                    <div class="col-sm-3 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="frontend_theme/frontend_images/iping/2.png" alt="Image">
<!--                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">News</p>
                                <h3 class="g-font-size-22--xs g-letter-spacing--1"><a href="https://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes">Jacks of All. Experts in All.</a></h3>
                                <p>The time has come to bring those ideas and plans to life.</p>
                    ...
                    <div class="col-sm-3">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="frontend_theme/frontend_images/iping/3.png" alt="Image">
<!--                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">News</p>
                      ...
                      <div class="col-sm-3">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="frontend_theme/frontend_images/iping/4.png" alt="Image">
<!--                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">News</p>
                                <h3 class="g-font-size-22--xs g-letter-spacing--1"><a href="https://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes">Finding your Perfect Place.</a></h3>
                                <p>The time has come to bring those ideas and plans to life.</p>
