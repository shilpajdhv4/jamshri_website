<footer class="g-bg-color--dark">
            ...
            <div class="container g-padding-y-50--xs">
                <div class="row">
                    <div class="col-xs-6">
                        <a href="index.html">
                            <img class="g-width-100--xs g-height-auto--xs" src="frontend_theme/img/logo.png" alt="Megakit Logo">
                        </a>
                    </div>
        ...
        <!-- Vendor -->
        <script type="text/javascript" src="frontend_theme/vendor/jquery.min.js"></script>
        <script type="text/javascript" src="frontend_theme/vendor/jquery.migrate.min.js"></script>
        <script type="text/javascript" src="frontend_theme/vendor/bootstrap/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="frontend_theme/vendor/jquery.smooth-scroll.min.js"></script>
        <script type="text/javascript" src="frontend_theme/vendor/jquery.back-to-top.min.js"></script>
        <script type="text/javascript" src="frontend_theme/vendor/scrollbar/jquery.scrollbar.min.js"></script>
        <script type="text/javascript" src="frontend_theme/vendor/magnific-popup/jquery.magnific-popup.min.js"></script>
        <script type="text/javascript" src="frontend_theme/vendor/swiper/swiper.jquery.min.js"></script>
        <script type="text/javascript" src="frontend_theme/vendor/waypoint.min.js"></script>
        <script type="text/javascript" src="frontend_theme/vendor/counterup.min.js"></script>
        <script type="text/javascript" src="frontend_theme/vendor/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
        <script type="text/javascript" src="frontend_themevendor/jquery.parallax.min.js"></script>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBsXUGTFS09pLVdsYEE9YrO2y4IAncAO2U"></script>
        <script type="text/javascript" src="frontend_theme/vendor/jquery.wow.min.js"></script>

        <!-- General Components and Settings -->
        <script type="text/javascript" src="frontend_theme/js/global.min.js"></script>
        <script type="text/javascript" src="frontend_theme/js/components/header-sticky.min.js"></script>
        <script type="text/javascript" src="frontend_theme/js/components/scrollbar.min.js"></script>
        <script type="text/javascript" src="frontend_theme/js/components/magnific-popup.min.js"></script>
        <script type="text/javascript" src="frontend_theme/js/components/swiper.min.js"></script>
        <script type="text/javascript" src="frontend_theme/js/components/counter.min.js"></script>
        <script type="text/javascript" src="frontend_theme/js/components/portfolio-3-col.min.js"></script>
        <script type="text/javascript" src="frontend_theme/js/components/parallax.min.js"></script>
        <script type="text/javascript" src="frontend_theme/js/components/google-map.min.js"></script>
        <script type="text/javascript" src="frontend_theme/js/components/wow.min.js"></script>
        <!--========== END JAVASCRIPTS ==========-->
